...
namespace engine
{
	...
	bool InnerProtocol::onSerialize(net::IOEvent* event, net::IBuffer* buffer)
	{
	...
	bool InnerProtocol::onUnserialize(net::IIOBuffer* buffer)
	{
		while (buffer->size() >= sizeof(Block))
		{
			Block block;
